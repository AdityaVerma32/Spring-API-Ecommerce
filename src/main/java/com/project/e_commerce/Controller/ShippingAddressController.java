...
public class ShippingAddressController {
    ...
    @PostMapping("add-new")
    public ResponseEntity<?> addAddress(@RequestBody ShippingAddress shippingAddress){
    ...
    public ResponseEntity<?> updateShippingAddress(@RequestBody ShippingAddress shippingAddress, @PathVariable Integer id){
        return shippingAddressService.updateAddress(id,shippingAddress);
    }

    // Fetching all the Shipping address of the current Users
    @GetMapping("fetch-all")
    public ResponseEntity<?> fetchAllShippingAddresses(){
